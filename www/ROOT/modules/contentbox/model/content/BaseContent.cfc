...
component persistent="true" entityname="cbContent" table="cb_content" cachename="cbContent" cacheuse="read-write" discriminatorColumn="contentType"{
	...
	property name="contentType" 			setter="false" update="false" insert="false"  default="" dbdefault="";
	...
	property name="isPublished" 			notnull="true"  ormtype="boolean" default="true" dbdefault="1" ;
	...
	property name="cache"					notnull="true"  ormtype="boolean" default="true" dbdefault="1" ;
	property name="cacheLayout"				notnull="true"  ormtype="boolean" default="true" dbdefault="1" ;
	property name="cacheTimeout"			notnull="false" ormtype="integer" default="0" dbdefault="0" ;
	property name="cacheLastAccessTimeout"	notnull="false" ormtype="integer" default="0" dbdefault="0" ;
