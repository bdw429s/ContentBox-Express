...
component persistent="true" entityname="cbContentVersion" table="cb_contentVersion" batchsize="25" cachename="cbContentVersion" cacheuse="read-write"{
	...
	property name="version"			notnull="true"  ormtype="integer"	default="1" dbdefalt="1" ;
	property name="createdDate" 	notnull="true"  ormtype="timestamp"	update="false" default="" ;
	property name="isActive" 		notnull="true"  ormtype="boolean"   	default="true" dbdefault="0" ;
	...
	// M20 -> relatedContent
	property name="relatedContent" notnull="true" cfc="contentbox.model.content.BaseContent" fieldtype="many-to-one" fkcolumn="FK_contentID" lazy="true" fetch="join" ;
