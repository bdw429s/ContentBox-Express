...
component persistent="true" entityname="cbComment" table="cb_comment" batchsize="25" cachename="cbComment" cacheuse="read-write" {
	...
	property name="isApproved" 		notnull="true"  ormtype="boolean" 	default="false" dbdefault="0" ;

	// M20 -> Content loaded as a proxy
	property name="relatedContent" notnull="true" cfc="contentbox.model.content.BaseContent" fieldtype="many-to-one" fkcolumn="FK_contentID" lazy="true" ;
