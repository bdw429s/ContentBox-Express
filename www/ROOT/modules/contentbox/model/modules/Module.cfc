...
component persistent="true" entityname="cbModule" table="cb_module" cachename="cbModule" cacheuse="read-write" {
	...
	property name="isActive"		notnull="true"  ormtype="boolean" default="false" dbdefault="0" ;
